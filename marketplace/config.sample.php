...
// ---- Outgoing email (verification links) ----
// InfinityFree's free plan blocks outbound SMTP (both PHP's mail() and
// authenticated SMTP via PHPMailer), so we send through Brevo's HTTPS API
// instead, which works fine since it's just a normal web request.
// 1. Sign up free at https://www.brevo.com (300 emails/day, no card needed)
// 2. Verify a sender email under Senders, Domains & Dedicated IPs
// 3. Get your API key from Settings -> SMTP & API -> API Keys -> Generate
define('SITE_URL',          'http://localhost/marketplace'); // no trailing slash
define('SMTP_HOST',  'smtp.gmail.com');
define('SMTP_PORT',  465);
define('SMTP_USER',  'REPLACE_WITH_YOUR_GMAIL_ADDRESS');
define('SMTP_PASS',  'REPLACE_WITH_YOUR_GMAIL_APP_PASSWORD');
